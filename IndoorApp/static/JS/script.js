		...
		var monumentos = L.geoJSON(hqDat, {
			...
			filter: function(feature, layer) {
				if(miSelect != "TODOS"){
					...
					console.log(x);
					return (feature.properties.name == miSelect || feature.properties.pe == miSelect || feature.properties.ref == miSelect || feature.properties.servicio == miSelect  || feature.properties.personal == miSelect  );
					//alert("hola");
					}	else
						return true;
				},
